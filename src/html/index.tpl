...
<head>
	...
	<meta property="og:image" content="{{url}}assets/img/social.png?{{version}}" />
	<meta property="og:url" content="{{url}}" />
	<meta property="og:site_name" content="{{label}}" />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="{{twitter}}" />
	<meta name="twitter:image" content="{{url}}assets/img/social.png?{{version}}" />
	...
	<link rel="icon" href="assets/img/favicon.png?{{version}}" type="image/png" />
  <link rel="preconnect" href="https://fonts.gstatic.com">
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="assets/css/site.css?{{version}}">
</head>
<body>
<header>
  <div class="wrapper">
    ...
    <ul class="social">
      <li class="github">
        <a href="https://github.com/draber/draber.github.io" rel="noopener" target="_blank">
          <img src="assets/img/GitHub-Mark-32px.png" alt="GitHub Respository">
        </a>
      </li>
      <li class="twitter">
        <a class="twitter-share-button" rel="noopener" data-show-count="false" href="https://twitter.com/share?ref_src=twsrc%5Etfw">Tweet</a> 
      ...
      <figure class="hive-box img-box">
        <svg viewBox="0 0 190.5 199" xmlns="http://www.w3.org/2000/svg">
          <g fill="#e6e6e6" class="cells">
            <path class="center" fill="#f8cd0f" d="M77.099 67.763L58.674 99.511l18.141 31.748h36.566l18.425-31.748-18.141-31.748z" />
          ...
          <g class="text">
            ...
            <path d="M95.498 160.05h3.7148v14.395h-3.7148z"/>
