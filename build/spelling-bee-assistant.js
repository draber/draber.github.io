(function () {
    ...
    const getCharacterKey = (combo) => {
        const match = combo.match(/(?:^|\+)(?:Key|Digit)?([A-Z0-9])(?:\+|$)/i);
    ...
    var shortcutRegistry = {
        ...
        get,
        normalizeCombo,
        handleShortcut: handleShortcut$1,
        getCharacterKey,
        registry,
    };
