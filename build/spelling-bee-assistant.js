    ...
    class Menu extends Plugin {
        ...
        constructor(app) {
            ...
            const classNames = [
                ...
                this.app.envIs("mobile")
                    ? "pz-nav__toolbar-item"
                    : "pz-toolbar-button",
            ];
            this.resetSubmenu();
            const pane = fn.ul({
