            ...
            this.observer = (() => {
                const observer = new MutationObserver(mutationsList => {
                    ...
                    if (node && node instanceof HTMLElement && node.textContent) {
                        this.trigger(prefix$1('newWord'), node.textContent.trim());
                    }
                });
