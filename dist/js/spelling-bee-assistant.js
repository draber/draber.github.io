(function () {
    ...
    var css = "@charset \"UTF-8\";\n[data-theme=\"light\"] {\n  --text-color: #000;\n  --link-color: #0f79bf;\n  --body-bg-color: #fff;\n  --modal-bg-color: rgba(255, 255, 255, 0.85);\n  --border-color: #dcdcdc;\n  --area-bg-color: #e6e6e6;\n  --invalid-color: #dcdcdc; }\n\n[data-theme=\"dark\"] {\n  --text-color: #e7eae1;\n  --link-color: #0f79bf;\n  --body-bg-color: #111;\n  --modal-bg-color: rgba(17, 17, 17, 0.85);\n  --border-color: #333;\n  --area-bg-color: #393939;\n  --invalid-color: #666; }\n\nhtml {\n  --highlight-color: rgb(248, 205, 5);\n  --shadow-light-color: rgba(248, 205, 5, .35);\n  --shadow-dark-color: rgba(248, 205, 5, .7);\n  --card-color: rgba(248, 205, 5, .1); }\n\n.pz-game-field {\n  background: inherit;\n  color: inherit; }\n\n.sb-wordlist-items .sb-pangram {\n  border-bottom: 2px var(--highlight-color) solid; }\n.sb-wordlist-items .sb-anagram a {\n  color: var(--invalid-color); }\n\n.sb-modal-scrim {\n  z-index: 6; }\n\n[data-sba-theme=\"dark\"] {\n  background: var(--body-bg-color);\n  color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .pz-nav__hamburger-inner,\n  [data-sba-theme=\"dark\"] .pz-nav__hamburger-inner::before,\n  [data-sba-theme=\"dark\"] .pz-nav__hamburger-inner::after {\n    background-color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .pz-nav {\n    width: 100%;\n    background: var(--body-bg-color); }\n  [data-sba-theme=\"dark\"] .pz-nav__logo {\n    filter: invert(1); }\n  [data-sba-theme=\"dark\"] .sb-modal-scrim {\n    background: var(--modal-bg-color);\n    color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .pz-modal__title {\n    color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .sb-modal-frame,\n  [data-sba-theme=\"dark\"] .pz-modal__button.white {\n    background: var(--body-bg-color);\n    color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .pz-modal__button.white:hover {\n    background: var(--area-bg-color); }\n  [data-sba-theme=\"dark\"] .sb-message {\n    background: var(--area-bg-color); }\n  [data-sba-theme=\"dark\"] .sb-input-invalid {\n    color: var(--invalid-color); }\n  [data-sba-theme=\"dark\"] .sb-toggle-expand {\n    box-shadow: none; }\n  [data-sba-theme=\"dark\"] .sb-progress-marker .sb-progress-value,\n  [data-sba-theme=\"dark\"] .hive-cell.center .cell-fill {\n    background: var(--highlight-color);\n    fill: var(--highlight-color);\n    color: var(--body-bg-color); }\n  [data-sba-theme=\"dark\"] .sb-input-bright {\n    color: var(--highlight-color); }\n  [data-sba-theme=\"dark\"] .hive-cell.outer .cell-fill {\n    fill: var(--area-bg-color); }\n  [data-sba-theme=\"dark\"] .cell-fill {\n    stroke: var(--body-bg-color); }\n  [data-sba-theme=\"dark\"] .cell-letter {\n    fill: var(--text-color); }\n  [data-sba-theme=\"dark\"] .hive-cell.center .cell-letter {\n    fill: var(--body-bg-color); }\n  [data-sba-theme=\"dark\"] .hive-action:not(.hive-action__shuffle) {\n    background: var(--body-bg-color);\n    color: var(--text-color); }\n  [data-sba-theme=\"dark\"] .hive-action__shuffle {\n    filter: invert(100%); }\n  [data-sba-theme=\"dark\"] *:not(.hive-action__shuffle):not(.sb-pangram):not(.sba-current) {\n    border-color: var(--border-color) !important; }\n\n.sba {\n  position: absolute;\n  z-index: 3;\n  width: 160px;\n  box-sizing: border-box;\n  padding: 0 10px 5px;\n  background: var(--body-bg-color);\n  border-width: 1px;\n  border-color: var(--border-color);\n  border-radius: 6px;\n  border-style: solid; }\n  .sba *,\n  .sba *:before,\n  .sba *:after {\n    box-sizing: border-box; }\n  .sba *:focus {\n    outline: 0; }\n  .sba [data-ui=\"header\"] {\n    display: flex;\n    gap: 8px; }\n    .sba [data-ui=\"header\"] .toolbar {\n      display: flex;\n      align-items: stretch;\n      gap: 1px; }\n      .sba [data-ui=\"header\"] .toolbar div {\n        padding: 10px 3px 2px 3px; }\n        .sba [data-ui=\"header\"] .toolbar div:last-of-type {\n          padding-top: 8px; }\n    .sba [data-ui=\"header\"] svg {\n      width: 11px;\n      cursor: pointer;\n      fill: currentColor; }\n  .sba .header {\n    font-weight: bold;\n    line-height: 32px;\n    flex-grow: 2; }\n  .sba .minimizer {\n    transform: rotate(180deg);\n    transform-origin: center;\n    position: relative;\n    top: 2px; }\n  .sba.inactive details,\n  .sba.inactive [data-ui=\"footer\"] {\n    display: none; }\n  .sba.inactive [data-tool=\"setUp\"] {\n    position: relative;\n    pointer-events: none; }\n    .sba.inactive [data-tool=\"setUp\"]:before {\n      content: '';\n      width: 100%;\n      height: 100%;\n      background-color: var(--modal-bg-color);\n      cursor: default;\n      display: block;\n      position: absolute;\n      top: 0;\n      left: 0; }\n  .sba.inactive .minimizer {\n    transform: rotate(0deg);\n    top: 0; }\n  .sba details {\n    font-size: 90%;\n    max-height: 800px;\n    transition: max-height 0.25s ease-in;\n    margin-bottom: 1px; }\n    .sba details[open] summary:before {\n      transform: rotate(-90deg);\n      left: 10px;\n      top: 1px; }\n    .sba details.inactive {\n      height: 0;\n      max-height: 0;\n      transition: max-height 0.25s ease-out;\n      overflow: hidden;\n      margin: 0; }\n  .sba summary {\n    font-size: 13px;\n    line-height: 22px;\n    padding: 1px 15px 0 21px;\n    background: var(--area-bg-color);\n    color: var(--text-color);\n    cursor: pointer;\n    list-style: none;\n    position: relative;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n    .sba summary::-webkit-details-marker {\n      display: none; }\n    .sba summary:before {\n      content: \"❯\";\n      font-size: 9px;\n      position: absolute;\n      display: inline-block;\n      transform: rotate(90deg);\n      transform-origin: center;\n      left: 7px;\n      top: 0; }\n  .sba .pane {\n    border: 1px solid var(--border-color);\n    border-top: none;\n    width: 100%;\n    font-size: 85%;\n    margin-bottom: 2px; }\n  .sba table {\n    border-collapse: collapse;\n    table-layout: fixed; }\n  .sba tr.sba-current {\n    font-weight: bold;\n    border-bottom: 2px solid var(--highlight-color) !important; }\n  .sba td {\n    border: 1px solid var(--border-color);\n    border-top: none;\n    white-space: nowrap;\n    text-align: center;\n    padding: 4px 0;\n    width: 26px; }\n    .sba td:first-of-type {\n      text-align: left;\n      width: auto;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      padding: 4px 3px; }\n  .sba [data-ui=\"scoreSoFar\"] tbody tr:first-child td,\n  .sba [data-ui=\"spoilers\"] tbody tr:first-child td {\n    font-weight: bold; }\n  .sba [data-ui=\"footer\"] {\n    color: currentColor;\n    opacity: .6;\n    font-size: 10px;\n    text-align: right;\n    display: block;\n    padding-top: 8px; }\n    .sba [data-ui=\"footer\"]:hover {\n      opacity: .8;\n      text-decoration: underline; }\n  .sba .spill-title {\n    padding: 10px 6px 0;\n    text-align: center; }\n  .sba .spill {\n    text-align: center;\n    padding: 17px 0;\n    font-size: 280%; }\n  .sba ul.pane {\n    padding: 5px; }\n  .sba [data-ui=\"surrender\"] .pane {\n    padding: 10px 5px; }\n  .sba [data-ui=\"surrender\"] button {\n    margin: 0 auto;\n    display: block;\n    font-size: 100%;\n    white-space: nowrap;\n    padding: 12px 10px; }\n  .sba label {\n    cursor: pointer;\n    position: relative;\n    line-height: 19px; }\n    .sba label input {\n      position: relative;\n      top: 2px;\n      margin: 0 10px 0 0; }\n\n@media (min-width: 768px) {\n  .sbaContainer {\n    width: 100%;\n    max-width: 1080px;\n    margin: 0 auto;\n    height: 0;\n    overflow-y: visible;\n    position: relative;\n    z-index: 5; }\n\n  .sba {\n    left: 100%;\n    top: 64px; } }\n@media (max-width: 1444px) {\n  .sbaContainer {\n    max-width: none; }\n\n  .sba {\n    top: 16px;\n    left: 12px; } }\n@media (max-width: 768px) {\n  .sba {\n    top: 167px; } }\n";
